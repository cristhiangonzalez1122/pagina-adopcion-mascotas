...
import {Persona, SolicitudAdopcion} from '../models';
...
export class PersonaSolicitudAdopcionController {
      ...
      '200': {
        ...
        content: {
          'application/json': {
            schema: {
              type: 'array',
              items: getModelSchemaRef(SolicitudAdopcion),
            },
          },
        },
      },
  ...
  @post('/personas/{id}/solicitud-adopcions', {
    responses: {
      '200': {
        ...
        content: {
          'application/json': {schema: getModelSchemaRef(SolicitudAdopcion)},
        },
      },
    },
  })
  async create(
    ...
    return this.personaRepository
      .SolicitudesDeAdopcion(id)
      .create(solicitudAdopcion);
  }
