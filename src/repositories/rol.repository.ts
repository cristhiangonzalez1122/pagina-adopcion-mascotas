...
> {
  ...
  constructor(
    @inject('datasources.mongodbds') dataSource: MongobddsDataSource, @repository.getter('UsuarioRepository') protected usuarioRepositoryGetter: Getter<UsuarioRepository>,
  ) {
